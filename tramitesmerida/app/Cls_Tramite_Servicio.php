    ...
    public function TRAM_CONSULTAR_CONFIGURACION_TRAMITE_PUBLICO($TRAM_NIDTRAMITE_CONFIG, $USTR_NIDUSUARIOTRAMITE = 0)
    {
        ...
        try {
            if($USTR_NIDUSUARIOTRAMITE == 0){
                ...
                $response['secciones'] = DB::select(
                    'SELECT a.SSEGTRA_NIDSECCION_SEGUIMIENTO, a.SSEGTRA_NIDSECCION_SEGUIMIENTO as CONF_NIDCONFIGURACION, a.SSEGTRA_NIDESTATUS as CONF_NESTATUS_SEGUIMIENTO, a.SSEGTRA_CNOMBRE_SECCION as CONF_NSECCION 
