        ...
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-md-4">
                    <div class="row">
                        <div class="col-md-3">
                            <a class="navbar-brand  Texto-menu" href="inicio.html">
                                <img src="{{ asset('assets/template/img/logoMerida.jpeg') }}" style="width: 70px;"  class="d-inline-block align-top" alt="">
                            </a>
                        </div>
...
return this.optional(element) || /^[a-z\s]+$/i.test(value);
       ...
       /* $('#selectcmbMunicipio_Particular').change(function(){
        ...
        function TRAM_AJX_CARGAR_MUNICIPIOS_ESTADOS(){
            var host2 =  'https://retys-queretaro.azurewebsites.net/api/Tramite/Municipios';
        ...
        function TRAM_AJX_CARGAR_ESTADOS(){
            var host2 =  'https://retys-queretaro.azurewebsites.net/api/Tramite/Estados';
            $.get(host2, function (data) {
                listadoEstados = data;
