...
<body>
    <table class="cont-60">
        <tr>
            <td class="text-center"><h4>MÉRIDA</h4> </td>
        </tr>
        <tr>
        <!--
    ...
    <table class="cont-60">
        <tr>
            <td class="text-left">
                <p>
                    Le informamos que el Sistema ha enviado con éxito la corrección de información sobre su trámite {{$_nombre_tramite}}.
                </p>
            </td>
        </tr>
        <tr>
    ...
    <table class="cont-60">
        <tr>
            <td class="text-center"><br />
              <br/><b>Atentamente</b><br />Sistema de Gestión de Trámites y Servicios (sMÉRIDA)
            </td>
        </tr>
    </table>
</body>
