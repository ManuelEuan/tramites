...
class Cls_Usuario extends Model
{
    ...
    static function TRAM_SP_AGREGARUSUARIO(Request $request){
        return DB::select('call TRAM_SP_AGREGARUSUARIO(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)'
                ...
                , $request->txtNumero_Interior_Fiscal ?? 0
                ...
                , $request->txtCalle_Particular ?? 0
                , $request->txtNumero_Interior_Particular ?? 0
                , $request->txtNumero_Exterior_Particular ?? 0
                , $request->txtCP_Particular ?? 0
                , $request->cmbColonia_Particular ?? 0
                , 0
                , $request->cmbMunicipio_Particular ?? 0
                , 0
                , $request->cmbEstado_Particular ?? 0
                , 0
                , $request->cmbPais_Particular ?? 0
                , 0
                , $request->txtNumeroTelefono ?? 0
                , $request->txtExtension ?? 0
                , $request->txtUsuario ?? 0
                , 0
                , 0
                , $request->fechaNacimientoFisica ?? null
                , $request->txtNumeroTelefono ?? 0
                , $request->txtNumeroTelefono ?? 0
                , $request->fechaConstitucionMoral ?? null
                , $request->nombrePersonaAutorizada
                ,''
                ,''
                ,$request->telefonoPersonaAutorizada ?? 0
                ,$request->telefonoPersonaAutorizada ?? 0
                ,$request->correoPersonaAutorizada
                ))[0]->{'LAST_INSERT_ID()'};
    }
    ...
    static function TRAM_SP_MODIFICARUSUARIO(Request $request){
        ...
        return DB::statement('call TRAM_SP_MODIFICARUSUARIO(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)'
                ...
                , $request->txtPrimer_Apellido
                , $request->txtSegundo_Apellido
                , $request->txtCalleFiscal
                , $request->txtNumeroInteriorFiscal
                , $request->txtNumeroExteriorFiscal
                , $request->txtCPFiscal
                , $request->txtColoniaFiscal
                , $request->cmbColonia_Particular
                , $request->txtMunicipioFiscal
                , $request->cmbMunicipio_Particular
                , $request->txtEstadoFiscal
                , $request->cmbEstado_Particular
                , $request->txtPaisFiscal
                , $request->cmbPais_Particular
                , $request->txtCorreo
                , $request->txtCorreoAlternativo
                , $request->txtCalleParticular
                , $request->txtNumeroInteriorParticular
                , $request->txtNumeroExteriorParticular
                , $request->txtNumeroCPParticular
                , $request->txtColoniaParticular
                , 0
                , $request->txtMunicipioParticular
                , 0
                , $request->txtEstadoParticular
                , 0
                , $request->txtPaisParticular
                , 0
