                            ...
                            <div class="tab-pane fade" id="documentos" role="tabpanel" aria-labelledby="documentos-tab">
                                <div class="col-md-12">
                                    ...
                                    <table class="table table-striped">
                                            ...
                                            <tbody>
                                                @foreach($ObjAuth['documentos'] as $doc)
                                                <tr>
                                                    <th><input type="checkbox"></th>
                                                    <th><i class="fa-solid fa-file-pdf" style="color: red;"></i></th>
                                                    <th>{{$doc->USDO_CDOCNOMBRE}}</th>
                                                    @if(round($doc->USDO_NPESO/1024) > 1024)
                                                    <th><label for="" id="size">{{round($doc->USDO_NPESO/1024)}} MB</label></th>
                                                    @else
                                                    <th><label for="" id="size">{{round($doc->USDO_NPESO/1024)}} KB</label></th>
                                                    @endif

                                                    @if($doc->USDO_NESTATUS == 2)
                                                    <th>Verificado</th>
                                                    <th><i class="fa-solid fa-circle-check" style="color: green;"></th>
                                                    @else
                                                    <th>Pendiente revision</th>
                                                    <th><i class="fa-solid fa-triangle-exclamation" style="color: orange;"></th>
                                                    @endif
                                                    <th><i class="fa-solid fa-circle-xmark" style="color: red;"></th>
                                                </tr>
                                                @endforeach                                               
                                            </tbody>
                                        </table>
