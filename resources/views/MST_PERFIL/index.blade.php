                    ...
                    <div class="col-md-12">
                        ...
                        <div>
                            ...
                            <ul class="nav nav-tabs nav-fill" id="myTab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="infoPersonal-tab" data-toggle="tab" href="#infoPersonal"
                                        role="tab" aria-controls="infoPersonal" aria-selected="true" onclick="hideSaveCancel(false)">INFORMACIÓN
                                        PERSONAL</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="predios-tab" data-toggle="tab" href="#predios" role="tab"
                                        aria-controls="predios" aria-selected="false" onclick="hideSaveCancel(false)">PREDIOS</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="documentos-tab" data-toggle="tab" href="#documentos"
                                    onclick="hideSaveCancel(true)"
                                        role="tab" aria-controls="documentos" aria-selected="false">DOCUMENTOS</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="resolutivos-tab" data-toggle="tab" href="#resolutivos"
                                        role="tab" aria-controls="resolutivos" aria-selected="false" onclick="hideSaveCancel(true)">RESOLUTIVOS</a>
                                </li>
                            </ul>
                            <br>
                                    ...
                                    <div class="tab-pane fade show active" id="infoPersonal" role="tabpanel"
                                        ...
                                        <div class="col-md-12">
                                            <div class="row justify-content-between">
                                                <div class="col-md-12 text-right">
                                                    <button class="btn btn-sm white btn-warning"
                                                        onclick="TRAM_FN_CONFIRMAR_PERFIL();">Cambiar contraseña</button>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="hidden" name="txtIdUsuario"
                                                value="{{ $ObjAuth->USUA_NIDUSUARIO }}" />
                                            <input type="hidden" name="rdbTipo_Persona"
                                                value="{{ $ObjAuth->USUA_NTIPO_PERSONA }}" />
                                            <div id="frmRegistro">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="bus-txt-centro-trabajo">RFC <span
                                                                    class="text-danger">*</span> <span
                                                                    class="text-primary">Se compone de 13
                                                                    caracteres</span></label>
                                                            <input type="text" class="form-control" id="txtRfc"
                                                                name="txtRfc" placeholder="RFC"
                                                                value="{{ $ObjAuth->USUA_CRFC }}" required disabled>
                                                    ...
                                                    <div class="col-md-6 divCurp">
                                                        <div class="form-group">
                                                            <label for="bus-txt-centro-trabajo">CURP<span
                                                                    class="text-danger">*</span><span
                                                                    class="text-primary">Se compone de 18 caracteres</span>
                                                                <span>&nbsp;&nbsp; <i class="fa fa-pencil-alt icon-edit"
                                                                        onclick="TRAM_FN_ENABLE('txtCurpFisica', 1);"></i></span></label>
                                                            <input type="text" class="form-control txtCurp"
                                                                name="txtCurp" id="txtCurpFisica" placeholder="CURP"
                                                                value="{{ $ObjAuth->USUA_CCURP }}" disabled>
                                                            <span class="resultadoValidTextCurp"
                                                                style="font-size: 12px;"></span>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6 divRazon_Social">
                                                        <div class="form-group">
                                                            <label for="bus-txt-centro-trabajo">Razón Social <span
                                                                    class="text-danger">*</span> <span>&nbsp;&nbsp;<i
                                                                        class="fa fa-pencil-alt icon-edit"
                                                                        onclick="TRAM_FN_ENABLE('txtRazon_Social', 1);"></i></span></label>
                                                            <input type="text" class="form-control"
                                                                name="txtRazon_Social" id="txtRazon_Social"
                                                                placeholder="Razón Social"
                                                                value="{{ $ObjAuth->USUA_CRAZON_SOCIAL }}" disabled>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        ...
                                                        <label for="bus-txt-centro-trabajo">Sexo <span
                                                                class="text-danger">*</span><i
                                                                class="fa fa-pencil-alt icon-edit"
                                                                onclick="TRAM_FN_ENABLE('rdbSexo', 2);"></i></span></label>
                                                        <div class="form-group">
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input rdbSexo" type="radio"
                                                                    value="F" name="rdbSexo"
                                                                    {{ $ObjAuth->USUA_NTIPO_SEXO == 'F' ? 'checked' : '' }}
                                                                    required disabled>
                                                                <label class="form-check-label">Mujer</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input rdbSexo" type="radio"
                                                                    value="M" name="rdbSexo"
                                                                    {{ $ObjAuth->USUA_NTIPO_SEXO == 'M' ? 'checked' : '' }}
                                                                    required disabled>
                                                        ...
                                                        <div class="row divCurp_Moral">
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    <label for="bus-txt-centro-trabajo">CURP <span
                                                                            class="text-danger">*</span><span
                                                                            class="text-primary">Se compone de 18
                                                                            caracteres</span> <span>&nbsp;&nbsp;<i
                                                                                class="fa fa-pencil-alt icon-edit"
                                                                                onclick="TRAM_FN_ENABLE('txtCurpMoral', 1);"></i></span></label>
                                                                    <input type="text" class="form-control txtCurp"
                                                                        name="txtCurp" id="txtCurpMoral"
                                                                        placeholder="CURP"
                                                                        value="{{ $ObjAuth->USUA_CCURP }}" disabled>
                                                                    <span class="resultadoValidTextCurp"
                                                                        style="font-size: 12px;"></span>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label for="bus-txt-centro-trabajo">Nombre (s) <span
                                                                    class="text-danger">*</span><span>&nbsp;&nbsp;<i
                                                                        class="fa fa-pencil-alt icon-edit"
                                                                        onclick="TRAM_FN_ENABLE('txtNombres', 1);"></i></span></label>
                                                            <input type="text" class="form-control" name="txtNombres"
                                                                id="txtNombres" placeholder="Nombre (s)"
                                                                value="{{ $ObjAuth->USUA_CNOMBRES }}" required disabled>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label for="bus-txt-centro-trabajo">Primer apellido <span
                                                                    class="text-danger">*</span><span>&nbsp;&nbsp;<i
                                                                        class="fa fa-pencil-alt icon-edit"
                                                                        onclick="TRAM_FN_ENABLE('txtPrimer_Apellido', 1);"></i></span></label>
                                                            <input type="text" class="form-control"
                                                                name="txtPrimer_Apellido" id="txtPrimer_Apellido"
                                                                placeholder="Primer apellido"
                                                                value="{{ $ObjAuth->USUA_CPRIMER_APELLIDO }}" required
                                                                disabled>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label for="bus-txt-centro-trabajo">Segundo apellido
                                                                <span>&nbsp;&nbsp;<i class="fa fa-pencil-alt icon-edit"
                                                                        onclick="TRAM_FN_ENABLE('txtSegundo_Apellido', 1);"></i></span></label>
                                                            <input type="text" class="form-control"
                                                                name="txtSegundo_Apellido" id="txtSegundo_Apellido"
                                                                placeholder="Segundo apellido"
                                                                value="{{ $ObjAuth->USUA_CSEGUNDO_APELLIDO }}" disabled>
                                                        </div>
                                                    </div>
                                                </div>
                                                <br />
                                                ...
                                                <div class="row divFechaNacimiento">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="bus-txt-centro-trabajo">Fecha de Nacimiento: <i
                                                                    class="fa fa-pencil-alt icon-edit"
                                                                    onclick="TRAM_FN_ENABLE('fechaNacimientoFisica', 1);"></i>
                                                            </label>
                                                            <br>
                                                            <input type="date" id="fechaNacimientoFisica"
                                                                name="fechaNacimientoFisica"
                                                                value="{{ $ObjAuth->USUA_DFECHA_NACIMIENTO }}" disabled>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="bus-txt-centro-trabajo">Correo electronico
                                                                        ...
                                                                        <span>&nbsp;&nbsp;<i
                                                                                class="fa fa-pencil-alt icon-edit"
                                                                                onclick="TRAM_FN_ENABLE('txtCorreo', 1);"></i></span></label>
                                                                    <input type="text" class="form-control"
                                                                        name="txtCorreo" id="txtCorreo"
                                                                        placeholder="ejemplo@correo.com"
                                                                        value="{{ $ObjAuth->USUA_CCORREO_ELECTRONICO }}"
                                                                        disabled>
                                                                </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="bus-txt-centro-trabajo">Correo electronico
                                                                        alternativo <span>&nbsp;&nbsp;<i
                                                                                class="fa fa-pencil-alt icon-edit"
                                                                                onclick="TRAM_FN_ENABLE('txtCorreoAlternativo', 1);"></i></span></label>
                                                                    <input type="text" class="form-control"
                                                                        name="txtCorreoAlternativo"
                                                                        id="txtCorreoAlternativo"
                                                                        placeholder="alternativo@correo.com"
                                                                        value="{{ $ObjAuth->USUA_CCORREO_ALTERNATIVO }}"
                                                                        disabled>
                                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <label for="bus-txt-centro-trabajo">Teléfono<span
                                                                class="text-danger">*</span> <span>&nbsp;&nbsp;<i
                                                                    class="fa fa-pencil-alt icon-edit"
                                                                    onclick="TRAM_FN_ENABLE('rdbTelefono', 2);"></i></span></label>
                                                        <div class="form-group">
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input rdbTelefono" type="radio"
                                                                    value="LOCAL" name="rdbTelefono" checked required
                                                                    disabled>
                                                                <label class="form-check-label">Local</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input rdbTelefono" type="radio"
                                                                    value="CELULAR" name="rdbTelefono" required disabled>
                                                                <label class="form-check-label">Celular</label>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <input type="text" class="form-control rdbTelefono"
                                                                name="txtTelefono" id="txtTelefono"
                                                                placeholder="9999999999"
                                                                value="{{ $ObjAuth->USUA_NTELEFONO }}" disabled>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <label for="bus-txt-centro-trabajo">Nombre (s) <span
                                                                class="text-danger">*</span> <i
                                                                class="fa fa-pencil-alt icon-edit"
                                                                onclick="TRAM_FN_ENABLE('nombrePersonaAutorizada', 1);"></i></label>
                                                        <div class="form-group">
                                                            <input class="form-control" type="text"
                                                                id="nombrePersonaAutorizada"
                                                                name="nombrePersonaAutorizada"
                                                                value="{{ $ObjAuth->USUA_CNOMBRE_NOTIFICACION }}"
                                                                placeholder="Nombre (s)" required disabled>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        <label for="bus-txt-centro-trabajo">Teléfono <span
                                                                class="text-danger">*</span> <i
                                                                class="fa fa-pencil-alt icon-edit"
                                                                onclick="TRAM_FN_ENABLE('telefonoPersonaAutorizada', 1);"></i></label>
                                                        <div class="form-group">
                                                            <input type="tel" class="form-control"
                                                                id="telefonoPersonaAutorizada"
                                                                name="telefonoPersonaAutorizada"
                                                                value="{{ $ObjAuth->USUA_CTEL_CELULAR_NOTIFICACION }}"
                                                                placeholder="999999999" pattern="[0-9]{3}[0-9]{3}[0-9]{4}"
                                                                placeholder="No. de teléfono" required disabled>
                                                        </div>
                                                    </div>

                                                    <div class="col-md-4">
                                                        <label for="bus-txt-centro-trabajo">Correo <span
                                                                class="text-danger">*</span> <i
                                                                class="fa fa-pencil-alt icon-edit"
                                                                onclick="TRAM_FN_ENABLE('correoPersonaAutorizada', 1);"></i></label>
                                                        <div class="form-group">
                                                            <input class="form-control" type="text"
                                                                id="correoPersonaAutorizada"
                                                                name="correoPersonaAutorizada"
                                                                value="{{ $ObjAuth->USUA_CCORREO_NOTIFICACION }}"
                                                                placeholder="Correo" required disabled>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row divDomicilio_Particular">
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label for="bus-txt-centro-trabajo">Calle <span
                                                                    class="text-danger">*</span><span>&nbsp;&nbsp;<i
                                                                        class="fa fa-pencil-alt icon-edit"
                                                                        onclick="TRAM_FN_ENABLE('txtCalle_Particular', 1);"></i></span></label>
                                                            <input type="text" class="form-control"
                                                                name="txtCalle_Particular" id="txtCalle_Particular"
                                                                placeholder="Calle"
                                                                value="{{ $ObjAuth->USUA_CCALLE_PARTICULAR }}" disabled>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label for="bus-txt-centro-trabajo">Número interior
                                                                <span>&nbsp;&nbsp;<i class="fa fa-pencil-alt icon-edit"
                                                                        onclick="TRAM_FN_ENABLE('txtNumero_Interior_Particular', 1);"></i></span></label>
                                                            <input type="number" class="form-control"
                                                                name="txtNumero_Interior_Particular"
                                                                id="txtNumero_Interior_Particular"
                                                                placeholder="Número interior"
                                                                value="{{ $ObjAuth->USUA_NNUMERO_INTERIOR_PARTICULAR }}"
                                                                disabled>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label for="bus-txt-centro-trabajo">Número exterior <span
                                                                    class="text-danger">*</span> <span>&nbsp;&nbsp;<i
                                                                        class="fa fa-pencil-alt icon-edit"
                                                                        onclick="TRAM_FN_ENABLE('txtNumero_Exterior_Particular', 1);"></i></span></label>
                                                            <input type="number" class="form-control"
                                                                name="txtNumero_Exterior_Particular"
                                                                id="txtNumero_Exterior_Particular"
                                                                placeholder="Número exterior"
                                                                value="{{ $ObjAuth->USUA_NNUMERO_EXTERIOR_PARTICULAR }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label for="bus-txt-centro-trabajo">C.P. <span
                                                                    class="text-danger">*</span><span>&nbsp;&nbsp;<i
                                                                        class="fa fa-pencil-alt icon-edit"
                                                                        onclick="TRAM_FN_ENABLE('txtCP_Particular', 1);"></i></span></label>
                                                            <input type="number" class="form-control"
                                                                name="txtCP_Particular" id="txtCP_Particular"
                                                                placeholder="C.P."
                                                                value="{{ $ObjAuth->USUA_NCP_PARTICULAR }}" disabled>
                                                        </div>
                                                    </div>
                                                </div>
                                                <br />
                                                <div class="row divDomicilio_Particular">
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label for="cmbColonia_Particular">Colonia <span
                                                                    class="text-danger">*</span><span>&nbsp;&nbsp;<i
                                                                        class="fa fa-pencil-alt icon-edit"
                                                                        onclick="TRAM_FN_ENABLE('cmbColonia_Particular', 1);"></i></span></label>
                                                            <select class="combobox form-control"
                                                                name="cmbColonia_Particular" id="cmbColonia_Particular"
                                                                title="Colonia"
                                                                value="{{ $ObjAuth->USUA_CCOLONIA_PARTICULAR }}"
                                                                disabled>
                                                                <option value="">Seleccione...</option>
                                                                <option value="Zona Centro"
                                                                    {{ $ObjAuth->USUA_CCOLONIA_PARTICULAR == 'Zona Centro' ? 'selected' : '' }}>
                                                                    Zona Centro</option>
                                                                <option value="San Pedro"
                                                                    {{ $ObjAuth->USUA_CCOLONIA_PARTICULAR == 'San Pedro' ? 'selected' : '' }}>
                                                                    San Pedro</option>
                                                                <option value="Sector Bolívar"
                                                                    {{ $ObjAuth->USUA_CCOLONIA_PARTICULAR == 'Sector Bolívar' ? 'selected' : '' }}>
                                                                    Sector Bolívar</option>
                                                                <option value="Nava"
                                                                    {{ $ObjAuth->USUA_CCOLONIA_PARTICULAR == 'Nava' ? 'selected' : '' }}>
                                                                    Nava</option>
                                                                <option value="Nogales Norte"
                                                                    {{ $ObjAuth->USUA_CCOLONIA_PARTICULAR == 'Nogales Norte' ? 'selected' : '' }}>
                                                                    Nogales Norte</option>
                                                                <option value="Pátzcuaro"
                                                                    {{ $ObjAuth->USUA_CCOLONIA_PARTICULAR == 'Pátzcuaro' ? 'selected' : '' }}>
                                                                    Pátzcuaro</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label for="cmbMunicipio_Particular">Municipio <span
                                                                    class="text-danger">*</span><span>&nbsp;&nbsp;<i
                                                                        class="fa fa-pencil-alt icon-edit"
                                                                        onclick="TRAM_FN_ENABLE('cmbMunicipio_Particular', 1);"></i></span></label>
                                                            <select class="combobox form-control"
                                                                name="cmbMunicipio_Particular"
                                                                id="cmbMunicipio_Particular" title="Municipio" disabled>
                                                                <option value="">Seleccione...</option>
                                                                <option value="Chihuahua"
                                                                    {{ $ObjAuth->USUA_CMUNICIPIO_PARTICULAR == 'Chihuahua' ? 'selected' : '' }}>
                                                                    Chihuahua</option>
                                                                <option value="Juárez"
                                                                    {{ $ObjAuth->USUA_CMUNICIPIO_PARTICULAR == 'Juárez' ? 'selected' : '' }}>
                                                                    Juárez</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label for="cmbEstado_Particular">Estado <span
                                                                    class="text-danger">*</span><span>&nbsp;&nbsp;<i
                                                                        class="fa fa-pencil-alt icon-edit"
                                                                        onclick="TRAM_FN_ENABLE('cmbEstado_Particular', 1);"></i></span></label>
                                                            <select class="combobox form-control"
                                                                name="cmbEstado_Particular" id="cmbEstado_Particular"
                                                                title="Estado" disabled>
                                                                <option value="">Seleccione...</option>
                                                                <option value="Chihuahua"
                                                                    {{ $ObjAuth->USUA_CESTADO_PARTICULAR == 'Chihuahua' ? 'selected' : '' }}>
                                                                    Chihuahua</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label for="cmbPais_Particular">País <span
                                                                    class="text-danger">*</span><span>&nbsp;&nbsp;<i
                                                                        class="fa fa-pencil-alt icon-edit"
                                                                        onclick="TRAM_FN_ENABLE('cmbPais_Particular', 1);"></i></span></label>
                                                            <select class="combobox form-control"
                                                                name="cmbPais_Particular" id="cmbPais_Particular"
                                                                title="País" disabled>
                                                                <option value="">Seleccione...</option>
                                                                <option value="México"
                                                                    {{ $ObjAuth->USUA_CPAIS_PARTICULAR == 'México' ? 'selected' : '' }}>
                                                                    México</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="checkbox"
                                                                    name="chbDomicilio_Mismo" id="chbDomicilio_Mismo"
                                                                    value="1">
                                                                <label class="form-check-label"
                                                                    for="chbDomicilio_Mismo"><span
                                                                        class="text-primary">¿El domicilio particular y el
...
@else
    ...
    @endif
                                    ...
                                    <!-- Div Predios-->
                                    <div class="tab-pane fade" id="predios" role="tabpanel"
                                        aria-labelledby="predios-tab">
                                                            ...
                                                            <div class="col-md-8">
                                                                <div class="form-check form-check-inline">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="opcionPredio" id="predioDireccion"
                                                                        value="DIRECCION">
                                                                    <label class="form-check-label"
                                                                        for="predioDireccion">Dirección</label>
                                                                </div>
                                                                <div class="form-check form-check-inline">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="opcionPredio" id="predioFolio"
                                                                        value="FOLIO">
                                                                    <label class="form-check-label"
                                                                        for="predioFolio">Folio</label>
                                                                </div>
                                                                <div class="form-check form-check-inline">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="opcionPredio" id="predioTablaje"
                                                                        value="TABLAJE">
                                                                    <label class="form-check-label"
                                                                        for="predioTablaje">Tablaje</label>
                                                                </div>
                                                            </div>
                                                        </dvi>
                                                    </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-2">
                                                                        <button class="btn btn-primary"
                                                                            style="height: 32px;font-size: inherit;">Añadir</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-12" id="accordion">
                                                            ...
                                                            <div class="card">
                                                                <div class="card-header" id="headingOne">
                                                                    <h5 class="mb-0">
                                                                        <button class="btn btn-link" id="domicilioP"
                                                                            ...
                                                                            <div class="col-md-12">
                                                                                <div class="row justify-content-md-center">
                                                                                    <div class="col-md-3">
                                                                                        ...
                                                                                        <input type="text"
                                                                                            class="form-control"
                                                                                            id="txtCalleParticular"
                                                                                            name="txtCalleParticular"
                                                                                            value="{{ $ObjAuth->USUA_CCALLE_PARTICULAR }}"
                                                                                            placeholder="21">
                                                                                    </div>
                                                                                    ...
                                                                                    <div class="col-md-3">
                                                                                        ...
                                                                                        <input type="number"
                                                                                            class="form-control"
                                                                                            id="txtNumeroInteriorParticular"
                                                                                            name="txtNumeroInteriorParticular"
                                                                                            value="{{ $ObjAuth->USUA_NNUMERO_INTERIOR_PARTICULAR }}"
                                                                                            placeholder="Número interior">
                                                                                    </div>
                                                                                    ...
                                                                                    <div class="col-md-3">
                                                                                        ...
                                                                                        <input type="number"
                                                                                            class="form-control"
                                                                                            id="txtNumeroExteriorParticular"
                                                                                            name="txtNumeroExteriorParticular"
                                                                                            value="{{ $ObjAuth->USUA_NNUMERO_EXTERIOR_PARTICULAR }}"
                                                                                            placeholder="Número exterior">
                                                                                    </div>
                                                                                    ...
                                                                                    <div class="col-md-3">
                                                                                        ...
                                                                                        <input type="number"
                                                                                            class="form-control"
                                                                                            id="txtNumeroCPParticular"
                                                                                            name="txtNumeroCPParticular"
                                                                                            value="{{ $ObjAuth->USUA_NCP_PARTICULAR }}"
                                                                                            placeholder="97000">
                                                                                    </div>
                                                                            ...
                                                                            <div class="col-md-12">
                                                                                <div class="row justify-content-md-center">
                                                                                    <div class="col-md-3">
                                                                                        ...
                                                                                        <input type="text"
                                                                                            class="form-control"
                                                                                            id="txtColoniaParticular"
                                                                                            name="txtColoniaParticular"
                                                                                            value="{{ $ObjAuth->USUA_CCOLONIA_PARTICULAR }}"
                                                                                            placeholder="Centro">
                                                                                    </div>
                                                                                    ...
                                                                                    <div class="col-md-3">
                                                                                        ...
                                                                                        <input type="text"
                                                                                            class="form-control"
                                                                                            id="txtMunicipioParticular"
                                                                                            name="txtMunicipioParticular"
                                                                                            value="{{ $ObjAuth->USUA_CMUNICIPIO_PARTICULAR }}"
                                                                                            placeholder="Mérida">
                                                                                    </div>
                                                                                    ...
                                                                                    <div class="col-md-3">
                                                                                        ...
                                                                                        <input type="text"
                                                                                            class="form-control"
                                                                                            id="txtEstadoParticular"
                                                                                            name="txtEstadoParticular"
                                                                                            value="{{ $ObjAuth->USUA_CESTADO_PARTICULAR }}"
                                                                                            placeholder="Yucatán">
                                                                                    </div>
                                                                                    ...
                                                                                    <div class="col-md-3">
                                                                                        ...
                                                                                        <input type="text"
                                                                                            class="form-control"
                                                                                            id="txtPaisParticular"
                                                                                            name="txtPaisParticular"
                                                                                            value="{{ $ObjAuth->USUA_CPAIS_PARTICULAR }}"
                                                                                            placeholder="México">
                                                                                    </div>
                                                                            ...
                                                                            <div class="col-md-12">
                                                                                <div class="row justify-content-md-center">
                                                                                    ...
                                                                                    <div class="col-md-3">
                                                                                        ...
                                                                                        <input type="number"
                                                                                            class="form-control"
                                                                                            id="txtNumeroInteriorFiscal"
                                                                                            name="txtNumeroInteriorFiscal"
                                                                                            value="{{ $ObjAuth->USUA_NNUMERO_INTERIOR }}"
                                                                                            placeholder="Número interior">
                                                                                    </div>
                                                                                    ...
                                                                                    <div class="col-md-3">
                                                                                        ...
                                                                                        <input type="number"
                                                                                            class="form-control"
                                                                                            id="txtNumeroExteriorFiscal"
                                                                                            name="txtNumeroExteriorFiscal"
                                                                                            value="{{ $ObjAuth->USUA_NNUMERO_EXTERIOR }}"
                                                                                            placeholder="Número exterior">
                                                                                    </div>
                                                                                ...
                                                                                <div class="row justify-content-md-center">
                                                                                    <div class="col-md-3">
                                                                                        ...
                                                                                        <input type="text"
                                                                                            class="form-control"
                                                                                            id="txtColoniaFiscal"
                                                                                            name="txtColoniaFiscal"
                                                                                            value="{{ $ObjAuth->USUA_CCOLONIA }}"
                                                                                            placeholder="Centro">
                                                                                    </div>
                                                                                    ...
                                                                                    <div class="col-md-3">
                                                                                        ...
                                                                                        <input type="text"
                                                                                            class="form-control"
                                                                                            id="txtMunicipioFiscal"
                                                                                            name="txtMunicipioFiscal"
                                                                                            value="{{ $ObjAuth->USUA_CMUNICIPIO }}"
                                                                                            placeholder="Mérida">
                                                                                    </div>
                                                                                    ...
                                                                                    <div class="col-md-3">
                                                                                        ...
                                                                                        <input type="text"
                                                                                            class="form-control"
                                                                                            id="txtEstadoFiscal"
                                                                                            name="txtEstadoFiscal"
                                                                                            value="{{ $ObjAuth->USUA_CESTADO }}"
                                                                                            placeholder="Yucatán">
                                                                                    </div>
                                                                                                            ...
                                                                                                            <div
                                                                                                                ...
                                                                                                                <div
                                                                                                                    ...
                                                                                                                    <div
                                                                                                                        class="form-group">
                                                                                                                        <label
                                                                                                                            for="bus-txt-centro-trabajo">Calle</label>
                                                                                                                        <input
                                                                                                                            type="text"
                                                                                                                            class="form-control txtCalle_Sucursal"
                                                                                                                            name="txtCalle_Sucursal"
                                                                                                                            id="{{ $IntIndex }}_txtCalle_Sucursal"
                                                                                                                            placeholder="Calle"
                                                                                                                            value="{{ $item->SUCU_CCALLE }}">
                                                                                                                    </div>
                                                                                                                </div>
                                                                                                                <div
                                                                                                                    class="col-md-3">
                                                                                                                    <div
                                                                                                                        class="form-group">
                                                                                                                        <label
                                                                                                                            for="bus-txt-centro-trabajo">Número
                                                                                                                            interior</label>
                                                                                                                        <input
                                                                                                                            type="number"
                                                                                                                            class="form-control txtNumero_Interior_Sucursal"
                                                                                                                            name="txtNumero_Interior_Sucursal"
                                                                                                                            id="{{ $IntIndex }}_txtNumero_Interior_Sucursal"
                                                                                                                            placeholder="Número interior"
                                                                                                                            value="{{ $item->SUCU_NNUMERO_INTERIOR }}">
                                                                                                                    </div>
                                                                                                                </div>
                                                                                                                <div
                                                                                                                    class="col-md-3">
                                                                                                                    <div
                                                                                                                        ...
                                                                                                                        <input
                                                                                                                            type="number"
                                                                                                                            class="form-control txtNumero_Exterior_Sucursal"
                                                                                                                            name="txtNumero_Exterior_Sucursal"
                                                                                                                            id="{{ $IntIndex }}_txtNumero_Exterior_Sucursal"
                                                                                                                            placeholder="Número exterior"
                                                                                                                            value="{{ $item->SUCU_NNUMERO_EXTERIOR }}">
                                                                                                                    </div>
                                                                                                                </div>
                                                                                                                <div
                                                                                                                    class="col-md-3">
                                                                                                                    <div
                                                                                                                        class="form-group">
                                                                                                                        <label
                                                                                                                            for="bus-txt-centro-trabajo">C.P.</label>
                                                                                                                        <input
                                                                                                                            type="number"
                                                                                                                            class="form-control txtCP_Sucursal"
                                                                                                                            name="txtCP_Sucursal"
                                                                                                                            id="{{ $IntIndex }}_txtCP_Sucursal"
                                                                                                                            placeholder="C.P."
                                                                                                                            value="{{ $item->SUCU_NCP }}">
                                                                                                                    </div>
                                                                                                                </div>
                                                                                                            ...
                                                                                                            <div
                                                                                                                ...
                                                                                                                <div
                                                                                                                    ...
                                                                                                                    <div
                                                                                                                        class="form-group">
                                                                                                                        <label
                                                                                                                            for="cmbColonia_Sucursal">Colonia
                                                                                                                        </label>
                                                                                                                        <input
                                                                                                                            type="text"
                                                                                                                            class="form-control cmbColonia_Sucursal"
                                                                                                                            name="cmbColonia_Sucursal"
                                                                                                                            id="{{ $IntIndex }}_cmbColonia_Sucursal"
                                                                                                                            placeholder="Centro"
                                                                                                                            value="{{ $item->SUCU_CCOLONIA }}">
                                                                                                                    </div>
                                                                                                                </div>
                                                                                                                <div
                                                                                                                    class="col-md-3">
                                                                                                                    <div
                                                                                                                        class="form-group">
                                                                                                                        <label
                                                                                                                            for="cmbMunicipio_Sucursal">Municipio
                                                                                                                        </label>
                                                                                                                        <input
                                                                                                                            type="text"
                                                                                                                            class="form-control cmbMunicipio_Sucursal"
                                                                                                                            name="cmbMunicipio_Sucursal"
                                                                                                                            id="{{ $IntIndex }}_cmbMunicipio_Sucursal"
                                                                                                                            placeholder="Mérida"
                                                                                                                            value="{{ $item->SUCU_CMUNICIPIO }}">
                                                                                                                    </div>
                                                                                                                </div>
                                                                                                                <div
                                                                                                                    class="col-md-3">
                                                                                                                    <div
                                                                                                                        class="form-group">
                                                                                                                        <label
                                                                                                                            for="cmbEstado_Sucursal">Estado</label>
                                                                                                                        <input
                                                                                                                            type="text"
                                                                                                                            class="form-control cmbEstado_Sucursal"
                                                                                                                            name="cmbEstado_Sucursal"
                                                                                                                            id="{{ $IntIndex }}_cmbEstado_Sucursal"
                                                                                                                            placeholder="Yucatán"
                                                                                                                            value="{{ $item->SUCU_CESTADO }}">
                                                                                                                    </div>
                                                                                                                </div>
                                                                                                                <div
                                                                                                                    class="col-md-3">
                                                                                                                    <div
                                                                                                                        class="form-group">
                                                                                                                        <label
                                                                                                                            for="cmbPais_Sucursal">País
                                                                                                                        </label>
                                                                                                                        <input
                                                                                                                            type="text"
                                                                                                                            class="form-control cmbPais_Sucursal"
                                                                                                                            name="cmbPais_Sucursal"
                                                                                                                            id="{{ $IntIndex }}_cmbPais_Sucursal"
                                                                                                                            placeholder="México"
                                                                                                                            value="{{ $item->SUCU_CPAIS }}">
                                                                                                                    </div>
                                                                                                                </div>
                                                                                                            </div>
                                                                                                        </div>
                                                                                                        <div
                                                                                                            class="col-md-1 row align-items-center">
                                                                                                            <div
                                                                                                                class="text-right">
                                                                                                                <span
                                                                                                                    class="circle-error"
                                                                                                            ...
                                                                                                            <div
                                                                                                                ...
                                                                                                                <div
                                                                                                                    ...
                                                                                                                    <input
                                                                                                                        ...
                                                                                                                        class="form-control txtNumero_Interior_Sucursal"
                                                                                                                        name="txtNumero_Interior_Sucursal"
                                                                                                                        id="txtNumero_Interior_Sucursal"
                                                                                                                        placeholder="Número interior"
                                                                                                                        value="">
                                                                                                                </div>
                                                                                                            </div>
                                                                                                            <div
                                                                                                                ...
                                                                                                                <div
                                                                                                                    ...
                                                                                                                    <input
                                                                                                                        ...
                                                                                                                        class="form-control txtNumero_Exterior_Sucursal"
                                                                                                                        name="txtNumero_Exterior_Sucursal"
                                                                                                                        id="txtNumero_Exterior_Sucursal"
                                                                                                                        placeholder="Número exterior"
                                                                                                                        value="">
                                                                                                                </div>
                                                                                                            </div>
                                    ...
                                    <!-- Div Resolutivos -->
                                    <div class="tab-pane fade" id="resolutivos" role="tabpanel"
                                        aria-labelledby="resolutivos-tab">
    ...
    <!-- Modal -->
    <div class="modal fade" id="ModalConfirmarCuenta" data-backdrop="static" data-keyboard="false" tabindex="-1"
        role="dialog" aria-labelledby="ModalConfirmarCuenta" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content border-radius-6">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form id="frmFormConfirmar_Cuenta" name="frmFormConfirmar_Cuenta">
                                <div class="form-group">
                                    <label id="ciudadano">RFC o Correo electrónico <span
                                            class="text-danger">*</span></label>
                                    <label id="servidor">Correo electrónico o Usuario <span
                                            class="text-danger">*</span></label>

                                    <input type="text" class="form-control" name="txtCorreo_RFC_Electronico"
                                        id="txtCorreo_RFC_Electronico" placeholder="RFC o Correo electrónico" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control" name="txtContrasena_Actual"
                                        id="txtContrasena_Actual" placeholder="Contraseña actual" required>
                                </div>
                            </form>
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                    <div class="row justify-content-between">
                        <div class="col-md-12 text-right">
                            <button class="btn btn-primary" id="btnSubmitConfirmaCuenta"
                                onclick="TRAM_AJX_CONFIRMAR_PERFIL();">Aceptar</button>
    ...
    <div class="modal fade" id="ModalCambiarContrasena" data-backdrop="static" data-keyboard="false"
        tabindex="-1" role="dialog" aria-labelledby="ModalCambiarContrasena" aria-hidden="true">
        <!-- Add .modal-dialog-centered to .modal-dialog to vertically center the modal -->
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content border-radius-6">
                <div class="modal-header">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form id="frmFormCmabiar_Contrasena" name="frmFormCmabiar_Contrasena">
                                <input type="hidden" name="txtIntIdUsuario"
                                    value="{{ $ObjAuth->USUA_NIDUSUARIO }}">
                                <input type="hidden" name="txtIntTipo" value="1">
                                <div class="form-group">
                                    <label>Ingresa nueva contraseña</label>
                                    <input type="password" class="form-control" name="txtContrasena_Nueva"
                                        id="txtContrasena_Nueva" placeholder="Nueva contraseña" required>
                                </div>
                                <div class="form-group">
                                    <label>Repetir contraseña</label>
                                    <input type="password" class="form-control" name="txtConformacion_Contrasena"
                                        id="txtConformacion_Contrasena" placeholder="Contraseña actual" required>
                                </div>
                            </form>
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                    <div class="row justify-content-between">
                        <div class="col-md-12 text-right">
                            <button class="btn btn-primary" id="btnSubmitConfirmaCuenta"
                                onclick="TRAM_AJX_CAMBIAR_CONTRASENA();">Aceptar</button>
                            <button class="btn btn-danger" data-dismiss="modal">Cerrar</button>
                        </div>
                    </div>
                </div>
    ...
    <!-- Modal ver docs -->
    <div class="modal fade" id="verDocsD" data-backdrop="static" data-keyboard="false"
        tabindex="-1" role="dialog" aria-labelledby="verDocsD" aria-hidden="true">
        <!-- Add .modal-dialog-centered to .modal-dialog to vertically center the modal -->
