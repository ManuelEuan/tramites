        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header titleCard">
                    <div class="row">
                        <div class="col-md-12" style="text-align: left;">
                            @if($tramite['TRAM_NIMPLEMENTADO'] > 0)
                            <div class="alert alert-warning" role="alert">
                                Está trabajando sobre una versión implementada, de guardar o implementar los cambios se creará otra versión.
                            </div>
                            @else
                            <div class="alert alert-success" role="alert">
                                Está trabajando sobre una versión que aún no esta implementada, sus cambios se guardarán en esta versión. Al implementar esta versión se sustituirá la versión ya implementada.
                            </div>
                            @endif
    ...
    $(document).ready(function() {
        ...
        function TRAM_AJX_OBTENER_DOCUMENTO_TRAMITE(list_document_select) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    //Agregar los documentos no seleccionados
                    $.each(list_temporal_documentos, function(i, v) {
        ...
        function TRAM_FN_AGREGAR_SECCION(list_section_tramite) {
            ...
            $.each(list_section_tramite, function(index, value) {
                ...
                /*if (value.CONF_NSECCION === "Revisión de documentación") {

                    dias_habiles = value.CONF_NDIASHABILES;

                } else if (value.CONF_NSECCION === "Citas en línea") {

                    textCita = value.CONF_CDESCRIPCIONCITA;

                } else if (value.CONF_NSECCION === "Ventanilla sin cita") {

                    textVentanilla = value.CONF_CDESCRIPCIONVENTANILLA;

                    if (tramite_.edificios.length > 0) {

                        $.each(tramite_.edificios, function(i, v) {
                            edificios.push(v.EDIF_CNOMBRE);
                        });
                    }

                } else if (value.CONF_NSECCION === "Pago en línea") {

                } else if (value.CONF_NSECCION === "Módulo de análisis interno del área") {

                } else if (value.CONF_NSECCION === "Resolutivo electrónico") {

                    if (tramite_.resolutivos.length > 0) {

                        $.each(tramite_.resolutivos, function(i, v) {
                            resolutivos.push(v.RESO_CNOMBRE);
                        });
                    }
        ...
        //Funcion ajax para obtener resolutivos del trámite
        $.get('/gestores/consultar_resolutivo', function(data) {
