        ...
        <div class="row" style="height: calc(100% - 92px);">
            <div class="col-md-8" style="text-align: left;">
                ...
                <div>
                    ...
                    <button id="btn_iniciar_tramite" onclick="TRAM_FN_INICIARTRAMITE({{ $tramite['id'] }});"
                        class="btn btn-sm btn-primary" style="margin: 2px;">Iniciar trámite</button>
                </div>
                <br>
                <div id="accordion">
                    <div class="card">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="documentTitle">
                                                        ...
                                                        <div class="documentInfo">
                                                            <span style="width: 100%;"><b>Presentación:</b>
                        ...
                        <div class="card-header" id="headingThree">
                            <h5 class="mb-0">
                                <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseThree"
                                    ...
                                    <i class="fa" aria-hidden="true"></i> Cómo o dónde realizarlo
                                </button>
                            </h5>
                        </div>
                                            ...
                                            @foreach ($linea['documentos'] as $documento)
                                                <div class="col-md-12">
                                                    <div class="documentTitle">
                                                        ...
                                                        <span class="spanTitle">{{ $documento['nombre'] }}</span>
                                                        <div class="documentInfo">
                                                            <span style="width: 100%;">Presentación:
                                                                {{ $documento['presentacion'] }}</span>
                                            ...
                                            @foreach ($fundamento['adicional'] as $adicional)
                                                <div class="col-md-12">
                                                    <div class="documentTitle">
                                                        ...
                                                        <div class="documentInfo">
                                                            <span
                                                                style="width: 100%;">{{ $adicional['descripcion'] }}</span>
                                                        </div>
                                                    </div>
                                                    <br>
                                                </div>
                ...
                <!--
                    <div class="card">
                        <div class="card-header" id="headingFive">
                            <h5 class="mb-0">
                                <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#fundaju"
                                    aria-expanded="false" aria-controls="collapseFive">
                                    <i class="fa" aria-hidden="true"></i> Fundamento jurídico
                                </button>
                            </h5>
                        </div>
                        <div id="fundaju" class="collapse" aria-labelledby="headingFive" data-parent="#accordion">
                            <div class="card-body">
                                @foreach ($tramite['fundamento_legal'] as $fundamento)
                                    <div class="row">
                                        <div class="col-md-12">
                        ...
                        <div class="card-header" id="headingFour">
                            <h5 class="mb-0">
                                <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseFour"
                                    ...
                                    <i class="fa" aria-hidden="true"></i> Costo
                                </button>
                            </h5>
                        </div>
                                            ...
                                            @foreach ($costo['documentos'] as $documento)
                                                <div class="col-md-12">
                                                    <div class="documentTitle">
                                                        ...
                                                        <div class="documentInfo">
                                                            <span
                                                                style="width: 100%;">{{ $documento['direccion'] }}</span>
                                                            <span
                                                                style="width: 100%; font-size: small; font-weight: 600;">Responsable:
                                                                {{ $documento['responsable'] }}</span>
                                                            <span
                                                                style="width: 100%; font-size: small; font-weight: 600;">Contacto:
                                                                {{ $documento['contacto_telefono'] }}</span>
                                                        </div>
                                                    </div>
                                                    <br>
                                                </div>
                    ...
                    <div class="col-12 ">
                        <div class="row d-flex justify-content-center" style="background-color: #ffffff;">
                            <div class="btn-group" role="group">
                                <button onclick="TRAM_FN_ANTERIOR_OFICINA();" type="button"
                                    class="btn btn-secondary sizeBtnArrow"><i class="fas fa-chevron-left"></i></button>
                                <button onclick="TRAM_FN_SIGUIENTE_OFICINA();" type="button"
                                    class="btn btn-secondary sizeBtnArrow"><i class="fas fa-chevron-right"></i></button>
                            </div>
                        </div>
                        ...
                        <div id="divOficina" class="row bg-azul-marino" style="height: calc(100% - 360px);">
                            <ul class="list-group w-all text-center">
                                ...
                                <li class="list-group-item text-white bg-border-none">
                                    <p id="text_direccion_oficina" class="text-white" style="margin:0px;">Tecnológico,
                                        2903 19</p>
                                    <p id="text_horario_oficina" class="text-white" style="margin:0px;">Verano: Domingos
                                        de 11:00 a 20:00 horas. Invierno: Domingos de 11:00 a 19:00 horas. Sujeto a cambios
                                        de horario.</p>

                                </li>
                                <li class="list-group-item text-white bg-border-none">
                                    <label class="lbl-white-bold">Responsable del trámite</label>
                                    <p id="text_responsable_oficina" class="text-white" style="margin:0px;">Lic. María
                                        Álvarez Monge, Directora de Esparcimiento.</p>
                                </li>
                                <li class="list-group-item text-white bg-border-none">
                                    <label class="lbl-white-bold">Contacto</label>
                                    <p id="text_telefono_oficina" class="text-white" style="margin:0px;">9999888771 Ext.
                                        123, 456</p>
            ...
            function TRAM_AJX_CONSULTARMODALIDAD() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $(data).each(function(i, v) { // indice, valor
                            cmbModalidad.append('<option value="' + v.id + '">' + v.nombre +
                                '</option>');
                        })
                        // Swal.fire({
                        //     icon: data.status,
            ...
            function TRAM_AJX_CONSULTARCLASIFICACION() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $(data).each(function(i, v) { // indice, valor
                            cmbClasificacion.append('<option value="' + v.id + '">' + v.nombre +
                                '</option>');
                        })
                        // Swal.fire({
                        //     icon: data.status,
            ...
            function TRAM_AJX_CONSULTARAUDIENCIA() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $(data).each(function(i, v) { // indice, valor
                            cmbAudiencia.append('<option value="' + v.id + '">' + v.nombre +
                                '</option>');
                        })
                    },
                    error: function(data) {
